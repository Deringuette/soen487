...
public class xmlRetrieve {
	public static void main (String[] args){
		...
		//XMLRetriever.requestXML("http://users.encs.concordia.ca/~s487_4/project/marfcat-out.xml", "soen487/XMLResources/marfcat-out.xml");
		//XMLRetriever.requestXML("http://users.encs.concordia.ca/~s487_4/examples/soap/faultmessage/faultSample.wsdl", "soen487/XMLResources/faultSample.wsdl");
	}
}
